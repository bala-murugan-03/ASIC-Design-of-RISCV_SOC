...
module design_1
  ...
  design_1_ila_0_0 ila_0
       (.clk(clk_wiz_0_clk_out1),
        ...
        .probe10(controller_0_bready),
        .probe11(axi_bram_ctrl_0_s_axi_bvalid),
        .probe2(controller_0_dataout),
        .probe3(controller_0_awvalid),
        .probe4(controller_0_awaddr),
        .probe5(controller_0_wvalid),
        .probe6(controller_0_wdata),
        .probe7(axi_bram_ctrl_0_s_axi_awready),
        .probe8(axi_bram_ctrl_0_s_axi_wready),
        .probe9(controller_0_wstrb));
endmodule
